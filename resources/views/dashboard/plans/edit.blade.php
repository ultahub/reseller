...
<section class="max-w-2xl mx-auto px-4 pt-16 pb-24">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold">Edit Plan</h1>
        <p class="text-gray-500">Update plan details</p>
    </div>
    ...
    <form action="{{ route('dashboard.plans.update', $plan) }}" method="POST" class="bg-white border border-gray-200 rounded-2xl p-8 space-y-6 shadow-sm">
        @csrf
        @method('PUT')

        <div>
            <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Plan Name <span class="text-red-500">*</span></label>
            <input type="text" id="name" name="name" value="{{ old('name', $plan->name) }}" placeholder="e.g., Starter, Pro, Enterprise" required
        ...
        <div class="grid sm:grid-cols-2 gap-4">
            <div>
                ...
                <div class="relative">
                    <input type="number" id="duration_days" name="duration_days" value="{{ old('duration_days', $plan->duration_days) }}" min="1" max="3650" required
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" id="price" name="price" value="{{ old('price', $plan->price) }}" step="0.01" min="0" max="99999" placeholder="0.00" required
        ...
        <div class="grid sm:grid-cols-2 gap-4">
            <div>
                ...
                <div class="relative">
                    <input type="number" id="bandwidth_gb" name="bandwidth_gb" value="{{ old('bandwidth_gb', $plan->bandwidth_gb) }}" min="1" max="99999" required
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition">
            ...
            <div>
                ...
                <input type="number" id="device_limit" name="device_limit" value="{{ old('device_limit', $plan->device_limit) }}" min="1" max="100" required
                       class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition">
